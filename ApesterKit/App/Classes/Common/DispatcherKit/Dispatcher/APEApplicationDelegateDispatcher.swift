...
///
///
open class APEApplicationDelegateDispatcher : UIResponder {
    ...
    ///
    public var monitoredApplicationServices : [APEApplicationDelegateService] {
    ...
    ///
    open func obtainServices() -> [APEApplicationDelegateService] {
        
        return []
    }
    
    fileprivate lazy var applicationServices : [APEApplicationDelegateService] = {
...
///
///
extension APEApplicationDelegateDispatcher : UIApplicationDelegate {
