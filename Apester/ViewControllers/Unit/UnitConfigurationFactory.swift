...
@objcMembers class UnitConfigurationsFactory: NSObject {
    ...
    static func configurations(for env: APEEnvironment = .production, hideApesterAds: Bool, gdprString: String?, baseUrl: String?, v: String?) -> [APEUnitConfiguration]  {
        ...
        return makeUnitConfigurations(with: unitsParams, environment: env, hideApesterAds: hideApesterAds, gdprString: gdprString, baseUrl: baseUrl, v: v)
    }
