...
public class APEStripHeader: NSObject
{
    ...
    public convenience init(
        text: String, size: CGFloat, family: String?, weight: Int, color: UIColor?, horizontalPadding: CGFloat
    ) {
        self.init(
            text: text,
            size: size,
    ...
    public convenience init(
        text: String, size: CGFloat, family: String?, weight: Int, color: UIColor?
    ) {
        self.init(
            text: text,
            size: size,
